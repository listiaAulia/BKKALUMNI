...
<head>
  ...
  <title>SoftLand Bootstrap Template - Pekerjaan</title>
    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="active" href="pricing">Lowongan</a></li>
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Lowongan yang tersedia</h1>
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Bursa kerja khuus (BKK) SMK YPC Tasikmalaya</p>
              </div>
            </div>
          </div>
        </div>
        ...
        @foreach ($lowongan as $item)
          <div class="col-md-4">
            <div class="card">
              <div class="card-body">
                <div class="row">
                    <img src="/storage/{{ $item->foto }}" alt="" srcset="">
                    <h5 class="fw-bold">{{ $item->judul }}</h5>
                    <hr>
                    <h6>{{ $item->perusahaan->nama }}</h6>
                    <h5>{{ $item->tanggal }}</h5>
                    <h8>{{ $item->deskripsi }}</h8>
                  </div>
                <a href="/detail/{{ $lowongan[0]->id_loker }}"><button type="submit">Lihat Detail</button></a>
              </div>
            </div>
          </div>
          @endforeach
