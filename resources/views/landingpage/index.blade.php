...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/bkk-removebg-preview.png" rel="icon">
    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="pricing">Lowongan</a></li>
  ...
  <main id="main">
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5" data-aos="fade">
          <div class="col-md-5 mb-5">
            <img src="{{ asset('SoftLand/assets/img/bkk.png') }}" alt="Image" class="img-fluid">
          </div>
        </div>
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="row justify-content mb-5">
          <div class="col-md-5" data-aos="fade-up">
            <h2 class="section-heading">TUJUAN</h2>
          </div>
        </div>
          <div class="row justify-content mb-2">
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="100">
              <p>1.Sebagai wadah dalam mempertemukan tamatan dengan pencari kerja.</p>
              <p>2.Memberikan layanan kepada tamatan sesuai dengan tugas dan fungsi masing-masing seksi yang ada dalam BKK.</p>
              <p>3.Sebagai wadah dalam pelatihan tamatan yang sesuai dengan permintaan pencari kerja.</p>
              <p>4.Sebagai wadah untuk menanamkan jiwa wirausaha bagi tamatan melalui pelatihan.</p>
            </div>
          </div>
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-5" data-aos="fade-up">
            <h2 class="section-heading">PERUSAHAAN</h2>
          </div>
        </div>
        ...
        {{-- <div class="row">
          ...
          <div class="row justify-content-center text-center mb-2">
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="50">
              {{-- <div class="wrap-icon icon-1">
                <i class="bi bi-brightness-high"></i>
              </div> --}}
              {{-- <h3 class="mb-3">Digital Whiteboard</h3> --}}
              <p class="mb-4">List Perusahaan yang bekerja sama dengan pihak BKK SMK YPC Tasikmalaya</p>
            </div>
          </div>
          {{-- <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="feature-1 text-center">
        ...
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-4">
            <h2 class="section-heading">Testimoni</h2>
             <p class="text-center">Testimoni BKK SMK YPC Tasikmalaya</p>
          </div>
        </div>
