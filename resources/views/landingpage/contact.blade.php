    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="login_alumni">Contact Us</a></li>
          ...
          {{-- <li><a class="active" href="contact">Login</a></li> --}}
        </ul>
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Contack Kami</h1>
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Bursa kerja khusus (BKK) SMK YPC Tasikmalaya</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row mb-5 align-items-end">
          <div class="col-md-6" data-aos="fade-up">
            ...
            <h2>Contact Form</h2>
            <p class="mb-0">Beberapa kontak yang bisa menghubungi kami</p>
          </div>
